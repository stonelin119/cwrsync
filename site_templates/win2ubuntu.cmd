...
rsync -avz --delete --exclude-from="exclude_list.txt" --chmod=Du=rwx,go=rx,Fu=rw,og=r /cygdrive/D/Workspace/Code/site_templates/* linfeng@192.168.1.177:/home/linfeng/workspace/code/mysite/
